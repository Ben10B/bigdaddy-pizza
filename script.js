...
bacon.addEventListener('click', addTopping, true);
...
bacon.addEventListener('click', removeTopping, true);
...
function addTopping(evt){
    if(evt.srcElement.id === "bacon" && evt.target.checked === true){
        ...
        toppingArrayStrings.push('Bacon');
        ...
        toppingArrayStrings.push('Pepperoni');
        ...
        toppingArrayStrings.push('Chicken');
        ...
        toppingArrayStrings.push('Mushrooms');
        ...
        toppingArrayStrings.push('Olives');
        ...
        toppingArrayStrings.push('Onion');
        ...
        toppingArrayStrings.push('Pineapple');
        ...
        toppingArrayStrings.push('Spinach');
        ...
        toppingArrayStrings.push('Sausage');
    }
    var str = "";
    for(var i =0; i < toppingArray.length; i++){
        str += toppingArray[i]+", ";
...
function removeTopping(evt){
    for(var i = toppingArray.length-1; i >= 0 ; i--){
        if(evt.srcElement.id === "bacon" && evt.target.checked === false){
            ...
            topAmount[0].children[0].selected = true; toppingArrayStrings.splice(i, 1);
            ...
            Details = "url(images/pizza/chicken-full.png)";
            if(toppingArray[i].includes(evt.srcElement.id) === true) toppingArray.splice(i, 1);
            ...
            Details = "url(images/pizza/ham-full.png)";
            if(toppingArray[i].includes(evt.srcElement.id) === true) toppingArray.splice(i, 1);
            ...
            Details = "url(images/pizza/mushrooms-full.png)";
            if(toppingArray[i].includes(evt.srcElement.id) === true) toppingArray.splice(i, 1);
            ...
            Details = "url(images/pizza/olives-full.png)";
            if(toppingArray[i].includes(evt.srcElement.id) === true) toppingArray.splice(i, 1);
            ...
            Details = "url(images/pizza/onion-full.png)";
            if(toppingArray[i].includes(evt.srcElement.id) === true) toppingArray.splice(i, 1);
            ...
            Details = "url(images/pizza/pineapple-full.png)";
            if(toppingArray[i].includes(evt.srcElement.id) === true) toppingArray.splice(i, 1);
            ...
            Details = "url(images/pizza/spinach-full.png)";
            if(toppingArray[i].includes(evt.srcElement.id) === true) toppingArray.splice(i, 1);
            ...
            Details = "url(images/pizza/sausage-full.png)";
            if(toppingArray[i].includes(evt.srcElement.id) === true) toppingArray.splice(i, 1);
        }
    }
    var str = "";
